                ...
                <form>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Nombres</label>
                        <input type="text" class="form-control" placeholder="Nombres Completos" value="">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Apellidos</label>
                        <input type="text" class="form-control" placeholder="Apellidos Completos" value="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" placeholder="Clave de Acceso" value="">
                      </div>
                    </div>
              ...
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    ...
                    <h5 class="title">Berney Montoya</h5>
                  </a>
                  <p class="description">
                    Director de Operaciones
                    berney.montoya@samaracosmetics.com
                  </p>
                </div>
