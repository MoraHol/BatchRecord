          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <a class="btn btn-primary" href="usuarios.php" role="button">Crear Usuario</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                     ...
                     <?php 
                      $query_usuarios = mysqli_query($conn, "SELECT u.nombre, u.apellido, u.email, c.cargo, m.modulo FROM usuario u INNER JOIN cargo c INNER JOIN modulo m ON u.id_cargo = c.id AND u.id_modulo = m.id");
