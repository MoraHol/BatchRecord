              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="savebatch.php" id="form-submit-batch" method="post" autocomplete="off">
                      ...
                      <div class="row page">
                        <div class="col-md-12 col-2 align-self-center">
                          ...
                          <select class="form-control " name="norefenrencia" id="name" required  onchange="cargarreferencia()" value="<?php echo $norefenrencia; ?>" >
